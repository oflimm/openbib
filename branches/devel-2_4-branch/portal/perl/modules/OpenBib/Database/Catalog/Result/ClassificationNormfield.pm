package OpenBib::Database::Catalog::Result::ClassificationNormfield;
...
__PACKAGE__->table("classification_normfields");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:HgH2+1AeMwH3ppTXK6v4Iw
