...
sub handler {
    ...
    my $basepath = $config->{base_loc}."/$view/".$config->{handler}{resource_person_loc}{name};
    $path=~s/$basepath//;
    ...
    $logger->debug("Type: person - Database: $database - Key: $id - Representation: $representation");
