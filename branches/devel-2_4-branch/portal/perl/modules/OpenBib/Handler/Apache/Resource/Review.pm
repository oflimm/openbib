...
sub show_record_negotiate {
    ...
    OpenBib::Common::Util::print_page($config->{tt_resource_review_single_tname},$ttdata,$r);
...
sub return_baseurl {
    ...
    my $new_location = "$config->{base_loc}/$view/$config->{handler}{resource_review_loc}{name}/$reviewid.html";
