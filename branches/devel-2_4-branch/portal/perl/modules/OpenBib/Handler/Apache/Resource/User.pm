...
###
    ...
    my $basepath = $config->{base_loc}."/$view/".$config->{handler}{resource_user_loc}{name};
    $path=~s/$basepath//;
    ...
    if ($path=~m/^\/(\d+)\/preferences\/($valid_representations_regexp)$/){
        $userid         = $1;
        $representation = $2;
        $action         = "showfields";
    }
    elsif ($path=~m/^\/(\d+)\/preferences/){
        $userid         = $1;
        $representation = '';
        $action         = "showfields";
    }
    elsif ($path=~m/^\/(\d+)\/litlists\/($valid_representations_regexp)$/){
        $litlistid       = $1;
        $representation = $2;
        $action   = "manage_lists";
    }    
    elsif ($path=~m/^\/(\d+)\/litlists/){
        $litlistid       = $1;
        $representation = '';
        $action   = "manage_lists";
    }    
    elsif ($path=~m/^\/(\d+)\/tags\/($valid_representations_regexp)$/){
        $litlistid       = $1;
        $representation = $2;
        $action   = "manage_tags";
    }    
    ...
    elsif ($path=~m/^\/(\d+)\/reviews\/($valid_representations_regexp)$/){
        $litlistid       = $1;
        $representation = $2;
        $action   = "manage_reviews";
    }    
    elsif ($path=~m/^\/(\d+)\/reviews/){
        $litlistid       = $1;
        $representation = '';
        $action   = "manage_reviews";
    }
    elsif ($path=~m/^\/(\d+)\/profiles\/($valid_representations_regexp)$/){
        $litlistid       = $1;
        $representation = $2;
        $action   = "manage_profiles";
    }    
    elsif ($path=~m/^\/(\d+)\/profiles/){
        $litlistid       = $1;
        $representation = '';
        $action   = "manage_profiles";
    }    
    ...
    elsif ($action eq "manage_private_lists"){
