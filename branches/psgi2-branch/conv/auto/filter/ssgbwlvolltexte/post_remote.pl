...
print "### $pool: Setzen des Medientyps auf Digital\n";

system("cd $pooldir/$pool ; zcat meta.title.gz| $rootdir/filter/$pool/add-mediatype.pl | gzip > meta.title.gz.tmp ; mv -f meta.title.gz.tmp meta.title.gz");
