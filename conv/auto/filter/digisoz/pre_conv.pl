...
system("cd $rootdir/data/$pool ; $rootdir/filter/$pool/add-fields.pl < meta.title | $rootdir/filter/$pool/enrich_from_cdm.pl > meta.title.tmp ; mv -f meta.title.tmp meta.title");
