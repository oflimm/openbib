...
system("cd $rootdir/data/$pool ; cat meta.title | $rootdir/filter/$pool/add-fields.pl | $rootdir/filter/$pool/remove_titles.pl | $rootdir/filter/$pool/remove_copyrighted.pl  > meta.title.tmp ; mv -f meta.title.tmp meta.title");
