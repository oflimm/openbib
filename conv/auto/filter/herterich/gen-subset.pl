...
$subset->identify_by_field_content('title',([ { field => '4700', content => '^Sammlung Günther Herterich' } ]));
$subset->identify_by_field_content('title',([ { field => '4700', content => '^Sammlung Günter Herterich' } ]));
$subset->write_set;
