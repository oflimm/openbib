...
#####################################################################
#
#  authority_pre_conv_corporatebody.pl
#
#  Bearbeitung der Koerperschafts-Normdaten
#
...
print "### $pool: Entfernen aller nicht GND-Fremdnummern sowie des (DE-588) GND-Prefixes aus Normdatei corporatebody\n";

system("cd $datadir/$pool ; cat authority_meta.corporatebody | $rootdir/filter/$pool/fix-gnd.pl > authority_meta.corporatebody.tmp ; mv -f authority_meta.corporatebody.tmp authority_meta.corporatebody");
