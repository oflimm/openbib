...
print "### $pool: Entferne Titel ohne Standort\n";

system("cd $datadir/$pool ; cat meta.title | $rootdir/filter/$pool/remove_titles_without_location.pl > meta.title.tmp ; mv -f meta.title.tmp meta.title");
