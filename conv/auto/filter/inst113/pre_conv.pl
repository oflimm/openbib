...
print "### $pool: Entfernung initial geladener Aufsaetze\n";

system("cd $rootdir/data/$pool ; $rootdir/filter/$pool/remove_articles.pl < meta.title > meta.title.tmp ; mv -f meta.title.tmp meta.title");
