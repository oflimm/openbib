...
print "### $pool: Titel mit Standort WP-Bibliothek entfernen\n";

system("cd $rootdir/data/$pool ; $rootdir/filter/$pool/remove_wp.pl < meta.title > meta.title.tmp ; mv -f meta.title.tmp meta.title");
