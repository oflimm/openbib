...
print "### $pool: Korrektur Inventarnummer aus 580 nach 005\n";

system("cd $rootdir/data/$pool ; cat meta.title | $rootdir/filter/$pool/fix-fields.pl > meta.title.tmp ; mv -f meta.title.tmp meta.title");
