...
print "### $pool: Erweiterung um Topics\n";
print "### $pool: Verarbeitung Jahre aus 008\n";

system("cd $rootdir/data/$pool ; cat meta.title | $rootdir/filter/$pool/add-fields.pl | $rootdir/filter/$pool/gen_local_topic.pl > meta.title.tmp ; mv -f meta.title.tmp meta.title");
