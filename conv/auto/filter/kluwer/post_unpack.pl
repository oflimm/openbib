...
print "### $pool: 'Leere' Felder entfernen\n";

system("cd $datadir/$pool ; cat meta.title | $rootdir/filter/$pool/remove_empty_fields.pl | $rootdir/filter/$pool/process_urls.pl > meta.title.tmp ; mv -f meta.title.tmp meta.title");
