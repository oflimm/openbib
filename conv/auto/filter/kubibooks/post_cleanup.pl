...
system("/opt/openbib/bin/gen_metrics.pl --database=kubibooks --type=14 --field=0264:b");
system("/opt/openbib/bin/gen_metrics.pl --database=kubibooks --type=14 --field=0264:a");
