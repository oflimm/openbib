...
system("cd $pooldir/$pool ; zcat meta.title.gz| $rootdir/filter/$pool/remove-titles-without-urls.pl | $rootdir/filter/$pool/add-availability.pl | gzip > meta.title.gz.tmp ; mv -f meta.title.gz.tmp meta.title.gz");
