...
system("cd $rootdir/data/$pool ; $rootdir/filter/$pool/add-availability.pl < meta.title | $rootdir/filter/$pool/exclude_oclc.pl > meta.title.tmp ; mv -f meta.title.tmp meta.title");
