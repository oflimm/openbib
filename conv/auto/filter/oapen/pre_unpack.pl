...
system("cd $pooldir/$pool ; zcat meta.title.gz| $rootdir/filter/$pool/add-locations.pl | $rootdir/filter/$pool/add-fields.pl | gzip > meta.title.gz.tmp ; mv -f meta.title.gz.tmp meta.title.gz");
