...
system("cd $rootdir/data/$pool ; cat meta.title | $rootdir/filter/$pool/add-availability.pl | $rootdir/filter/$pool/add-locationid.pl > meta.title.tmp ; mv -f meta.title.tmp meta.title");
