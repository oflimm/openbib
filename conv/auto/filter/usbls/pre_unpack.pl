...
print "### $pool: Entfernen der Zugriffsinformation\n";

system("cd $pooldir/$pool ; zcat meta.title.gz| $rootdir/filter/$pool/drop-availability.pl | gzip > meta.title.gz.tmp ; mv -f meta.title.gz.tmp meta.title.gz");
