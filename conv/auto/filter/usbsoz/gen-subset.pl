...
$subset->identify_by_field_content('title',([ { field => '4712', content => 'wiso' } ]));
$subset->identify_by_field_content('title',([ { field => '4102', content => '^8' } ]));
$subset->exclude_by_field_content('title',([ { field => '4712', content => '^wi$' } ]));
$subset->write_set;
