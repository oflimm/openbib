...
$subset->identify_by_field_content('title',([ { field => '0980', subfield => 's', content => '^Sammlung Fritz von Westerholt' }, { field => '0980', subfield => 's', content => '^Sammlung Westerholt' }, { field => '0980', subfield => 's', content => '^Sammlung Wilhelmine von Westerholt' } ]));
$subset->write_set;
