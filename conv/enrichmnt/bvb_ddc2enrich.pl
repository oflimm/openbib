...
#  bvb_ddc2enrich.pl
#
#  Extrahierung der DDC aus den BVB Open Data Dumps
...
$logfile=($logfile)?$logfile:"/var/log/openbib/bvb_ddc-enrichmnt.log";
...
sub print_help {
    print << "ENDHELP";
bvb_ddcs2enrich.pl - Anreicherung mit DDC-Informationen aus den offenen Daten des BVB
