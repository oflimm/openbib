...
Geübte Such-Experten koennen in der Komplexen Suche wie bisher alle
bibliothekarisch anspruchsvollen Anfragen über das bereits vorhandene
...
Gegensatz zur einfachen damit zu rechnen, daß der Nutzer schon
...
\item Es sind -- in einem gewissen Umfang -- keine komplexen
  Suchanfragen möglich. Alle eingegebenen Begriffe werden implizit mit
...
\item Bei den Ergebnissen wird die Zahl aller gefundenen Titel
  ...
  50), allerdings sind diese Treffer -- im Gegensatz zur bisherigen
...
bestimmt, die besonders häufig vorkommen -- geordnet nach dem Kategoriekreis
...
sowie Jahreszahlen. Hat der Benutzer also eine Treffermenge bekommen, so
