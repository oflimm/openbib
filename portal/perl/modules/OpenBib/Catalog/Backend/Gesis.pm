#####################################################################
#
#  OpenBib::Catalog::Backend::Gesis.pm
#
#  Objektorientiertes Interface zum Gesis Elasticsearch API
#
...
package OpenBib::Catalog::Backend::Gesis;
...
sub new {
    ...
    my $api = new OpenBib::API::HTTP::Gesis($arg_ref);
...
OpenBib::Catalog::Backend::Gesis - Objektorientiertes Interface zum Gesis Solr-API

=head1 DESCRIPTION

Mit diesem Objekt kann auf das Solr-API des Gesis zugegriffen werden, um auf einen Katalog-Titel uber das vereinheitlichte OpenBib::Catalog Objekt zuzugreifen

=head1 SYNOPSIS

 use OpenBib::Catalog::Backend::Gesis;

 my $eds = OpenBib::Catalog::Backend::Gesis->new({});
