package OpenBib::Database::Catalog::Result::HoldingNormfield;
...
__PACKAGE__->table("holding_normfields");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:NY8eis9UmH2KP7ymKlePnQ
