#####################################################################
#
#  OpenBib::Handler::Apache::CorporateBodies::Titles.pm
#
...
package OpenBib::Handler::Apache::CorporateBodies::Titles;
...
sub show_recent {
    ...
    $self->print_page($config->{'tt_corporatebodies_record_titles_recent_tname'},$ttdata);
