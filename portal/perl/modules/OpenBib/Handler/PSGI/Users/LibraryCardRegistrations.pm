#####################################################################
#
#  OpenBib::Handler::PSGI::Users::LibraryCardRegistrations
#
...
package OpenBib::Handler::PSGI::Users::LibraryCardRegistrations;
...
sub register {
	...
	if ($register_ref->{error_description}){
	    return $self->print_warning(encode_entities($register_ref->{error_description}));
	}
	else {
