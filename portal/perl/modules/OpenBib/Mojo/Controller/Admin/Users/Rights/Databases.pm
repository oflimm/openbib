#####################################################################
#
#  OpenBib::Mojo::Controller::Admin::Users::Rights::Databases
#
...
package OpenBib::Mojo::Controller::Admin::Users::Rights::Databases;
...
sub update_record {
    ...
    $user->update_userdatabases($thisuserinfo_ref);
