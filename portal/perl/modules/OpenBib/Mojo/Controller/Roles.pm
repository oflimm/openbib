...
package OpenBib::Mojo::Controller::Roles;
...
sub show_collection {
    ...
    return $self->print_page($config->{tt_roles_tname},$ttdata);
}
...
sub show_record {
    ...
    return $self->print_page($config->{tt_roles_record_tname},$ttdata);
}
