#####################################################################
#
#  OpenBib::Mojo::Controller::Views::RSS
#
...
package OpenBib::Mojo::Controller::Views::RSS;
...
sub show_collection {
    ...
    my $rssfeed_ref= $config->get_rssfeeds_of_view($viewname);;
...
sub show_record {
    ...
    return $self->print_page($config->{tt_views_rss_record_tname},$ttdata);
}
