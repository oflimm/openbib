#####################################################################
#
#  OpenBib::Schema::Statistics::Singleton
#
...
package OpenBib::Schema::Statistics::Singleton;
...
sub connect {
    ...
    $schema_pool{$args_key} = OpenBib::Schema::Statistics->connect(@args);
...
OpenBib::Schema::Statistics::Singleton - Singleton zum Spooling von Statistics-Schemas
