...
#####################################################################
#
#  update_tittag_titlecache.pl
#
#  Aktualisierung der Titel-Cache-Informationen fuer vergebene Tags
#
...
sub print_help {
    print << "ENDHELP";
update_tittag_titlecache.pl - Aktualisierung der Titel-Cache-Informationen der getaggten Titel
