...
$subset->identify_by_field_content('classification',([ { field => '0800', content => '^Sammlung Fritz von Westerholt' },{ category => '0800', content => '^Sammlung Westerholt' },{ category => '0800', content => '^Sammlung Wilhelmine von Westerholt' } ]));
$subset->write_set;
