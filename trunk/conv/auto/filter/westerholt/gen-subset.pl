...
$subset->identify_by_category_content('classification',([ { category => '0800', content => '^Sammlung Fritz von Westerholt' },{ category => '0800', content => '^Sammlung Westerholt' },{ category => '0800', content => '^Sammlung Wilhelmine von Westerholt' } ]));
$subset->write_set;
