...
#	   "0016" => "7600 ", # Standort
	   ...
	   "0035.001" => "8200.001 ", # Erschland
	   "0035.002" => "8200.002 ", # Erschland
	   "0035.003" => "8200.003 ", # Erschland
	   "0035.004" => "8200.004 ", # Erschland
	   "0035.005" => "8200.005 ", # Erschland
...
#	   "0153" => "     ", # ???
	   ...
	   "0413.001" => "8201.001 ", # Drucker
	   "0413.002" => "8201.002 ", # Drucker
	   "0413.003" => "8201.003 ", # Drucker
	   "0413.004" => "8201.004 ", # Drucker
	   "0413.005" => "8201.005 ", # Drucker
	   ...
	   "0435.001" => "8202.001 ", # Format
	   "0435.002" => "8202.002 ", # Format
	   "0435.003" => "8202.003 ", # Format
	   "0435.004" => "8202.004 ", # Format
	   "0435.005" => "8202.005 ", # Format
...
#	   "0455" => "4200 ", # BdAngVorl (Sonderbehandlung, s.u.)
	   ...
	   #"0501.001" => "4400 ", # Fussnoten (Sonderbehandlung, s.u.)
	   "0507.001" => "8080 ", # AngabenHST
	   "0508.001" => "8203.001 ", # Quelle
	   "0508.002" => "8203.002 ", # Quelle
	   "0508.003" => "8203.003 ", # Quelle
	   "0508.004" => "8203.004 ", # Quelle
	   "0508.005" => "8203.005 ", # Quelle
#	   "0511" => "     ", # ErschVermF
