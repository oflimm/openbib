#####################################################################
#
#  OpenBib::Handler::Apache::Collections
#
...
package OpenBib::Handler::Apache::Collections;
...
sub return_baseurl {
    ...
    my $new_location = ($userid)?"$path_prefix/$config->{users_loc}/id/$userid/collection.html":"$path_prefix/$config->{collection_loc}.html";
